...
public interface BankAccountRepository extends JpaRepository<BankAccount, Long>, CrudRepository<BankAccount, Long>, PagingAndSortingRepository<BankAccount, Long> {
